                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('fechaSolicitud') }}" id="fechaSolicitud"
                                                    class="form-control " name="fechaSolicitud" type="date">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('capacidadRequerida') }}" id="capacidadRequerida"
                                                    ...
                                                    placeholder="Ingrese la capacidad requerida">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="basicSelect" name="prioridadNormal"
                                                    ...
                                                    <option value="0" {{ old('prioridadNormal') == 0 ? 'selected' : '' }}>
                                                        Normal</option>
                                                    <option value="1" {{ old('prioridadNormal') == 1 ? 'selected' : '' }}>
                                                        Urgente</option>
                                                </select>
