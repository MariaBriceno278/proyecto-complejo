    ...
    <section class="main">
        ...
        <div class="content-w3ls">
            <div class="text-center icon">
                ...
                <br>
                <br>
                <h2 style="color: aliceblue;font-size: 40px;">Iniciar Sesión</h2>
            </div>
                ...
                <form  method="POST" action="{{ url('login') }}">
                  ...
                  @endif
                   ...
                   @endif
                    ...
                    <label style="color: aliceblue;" for="password">Contraseña</label><br>
                    ...
                    <ul class="list-login">
                        ...
                        <li>
                            <a style="color: #ccc" class="text-right" data-toggle="modal" data-target="#myModal">Acepta Términos y Condiciones -</a>
                            <a href="{{url('recuperar-password')}}" class="text-right"> Olvidó la Contraseña?</a><br>
