                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="basicSelect" name="idTipoInvolucradoFK"
                                                    class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="basicSelect" name="idInvolucradoFK"
                                                    class="form-control">
                                                    <option value=""> -- Seleccione Tipo Involucrado --</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea value="{{ old('observacionesDetalleCaso') }}"
